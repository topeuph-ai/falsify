...
- **Four reference implementations** — Python (PyYAML), Node.js (~400 LOC), Go (~450 LOC), Rust (~600 LOC); all four pass 21/21 vectors byte-for-byte. CI verifies 4 × 21 = 84 byte-for-byte agreements per push. See [`impl/`](impl/).
